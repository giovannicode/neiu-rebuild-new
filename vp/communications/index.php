 ...
 ********************************************************************************************-->
  ...
  <div id="marginer1">
     ...
     ***************************************************************************************-->
     ...
     <div class="departmentMainContent">
        ...
        <p>
        Please fill out the <a href="/vp/communications/communications_request_form.php">Communications Request Form</a> to begin the process. Our team will be in touch with you soon to discuss your promotional needs. 
        For requests of materials that will be used for marketing externally, off-campus, or outside the university community please contact  Marketing at 773-509-5627 or use</strong><strong> the 
           <a href="http://www.neiu.edu/~markdep/project_request/index.php" target="_blank">Marketing Project Request Form</a></strong>.</p>
             
           <p class="context">Please send requests <strong>AT LEAST 10 business days before the DUE date</strong>.  We will do our best to fulfill urgent 
           requests, but due to volume of requests, we cannot guarantee they will all be accommodated.</p>
               
           <p class="context">The Communications Request form includes a targeted announcement and web section, and replaces the Targeted Announcement 
           (TA) and Web Revision Request forms. Refer to the <strong><a target="_blank" href="/vp/communications/files/TAG.pdf">Targeted 
           Announcement guidelines</a></strong> and <a href="#web"><strong>Web Revision 
        ...
        If additional content approvals are required within your area, you must include their contact info. For questions about our 
        guidelines or form, please contact SAComm@neiu.edu. 
        </p>
 ...
 <a name="web"></a><h3>Web Page Requests</h3>
        
        <p>
        For those of you who would like help, the Communications team is available to assist you with updating and enhancing your web pages. Please note that the university is revamping the main university web site, with the initial phases underway as of March 
        2013, and expected completion in March 2014.
        </p>
